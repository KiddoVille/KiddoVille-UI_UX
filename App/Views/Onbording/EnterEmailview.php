  ...
  <div class="container" style="display: flex; justify-content: center; margin-top: 20px;">
    ...
    <div class="box"
      ...
      <div class="filter-box">
        ...
        <button onclick="window.location.href='<?=ROOT?>/Onbording/EnterNumber'" type="button" style="width:200px;margin-top: 20px;">Direct</button>
      </div>
    </div>
  </div>
  ...
  <script>
    document.addEventListener('DOMContentLoaded', function () {
      ...
      form.addEventListener('submit', function (event) {
        ...
        fetch('<?= ROOT ?>/Onbording/EnterEmail/StoreEmail', {
          method: 'POST',
          headers: {
        ...
        .then(data => {
          if (data.success) {
              window.location.href = '<?= ROOT ?>/Onbording/VerifyEmail';
          } else {
