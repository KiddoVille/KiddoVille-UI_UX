        ...
        <div class="box fade-out" id="fade"
            ...
            <div class="container-border">
                <div class="container-content">
                    ...
                    <?= show($_SESSION['APP']['OTP']) ?>
                    <p style="text-align: center; padding: 0px 28px ">
                        Please enter the code sent to <strong><?=$data['Number'] ?></strong>. to verify your contact change.</p>
                    <form id="otp-form" style="margin-top: 40px; margin-bottom: 40px;">
                        ...
                        <button style="margin-top: 20px;" type="submit">Verify Contact</button>
                        ...
                        <a class="forgot-password" style="padding: 0px 0px;margin-left: 95px; color:#8136F3" href="<?=ROOT?>/Parent/ParentProfile"><strong>Use Different Contact</strong></a>
                    </form>
                </div>
            </div>
        </div>
        ...
        document.addEventListener('DOMContentLoaded', function () {
            ...
            document.getElementById('otp-form').addEventListener('submit', function(e) {
                ...
                if (otpEntered.length === 4) {
                    ...
                    fetch('<?=ROOT?>/Onbording/VerifyNumber/verify', {
                        method: 'POST',
                        headers: {
