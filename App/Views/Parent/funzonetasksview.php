...
<body>
    ...
    <script>
        ...
        function removechildsession() {
            fetch('<?= ROOT ?>/Parent/Funzonetask/removechildsession', {
                    method: 'POST',
                    headers: {
        ...
        function setChildSession(ChildID) {
            fetch('<?= ROOT ?>/Parent/Funzonetask/setchildsession', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json'
                    },
                ...
                .then(data => {
                    if (data.success) {
                        ...
                        window.location.href = '<?= ROOT ?>/Child/Funzonetask';
                    } else {
        ...
        function fetchMedia(type) {
            fetch('<?= ROOT ?>/Parent/Funzonetasks/store_tasks', {
                    method: 'POST',
                    headers: {
                        'Content-Type': 'application/json'
                    },
