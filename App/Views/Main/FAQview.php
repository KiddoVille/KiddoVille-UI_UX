...
<body style="background:url(<?=IMAGE?>/back-login.jpg); background-size:cover; ">
    ...
    <div class="wrapper">
        ...
        <div class="faq">
            ...
            <div class="pannel">
                <p>
                    KIDDO VILLE is a premier daycare facility that offers a safe, nurturing, and fun environment for children to learn and grow while their parents are at work or busy with other responsibilities.
                </p>
            </div>
        </div>
        ...
        <div class="faq">
            ...
            <div class="pannel">
                <p>
                    KIDDO VILLE accepts children 2 years to 12 years old. We have specific programs tailored to the developmental needs of each age group.
                </p>
            </div>
        </div>
        ...
        <div class="faq">
            ...
            <div class="pannel">
                <p>
                    We are open Monday through Friday from 7:00 AM to 6:00 PM. We also offer extended hours upon request.
                </p> <br>
                <p>
                    We also provides 24-hour care and support to accommodate the diverse schedules ensureig your child is safe and well-cared for around the clock.
                </p>
            </div>
        </div>
        ...
        <div class="faq">
            ...
            <div class="pannel">
                <p> At KIDDO VILLE, the safety of our children is our top priority. We have a secure entry system, CCTV cameras in all common areas. Our facility is also child-proofed and regularly inspected for safety compliance. </p> <br>
                <p> We accommodate children's medicine and work closely with our in-house doctors to monitor and handle any illnesses.</p>
            </div>
        </div>
        ...
        <div class="faq">
            ...
            <div class="pannel">
                <p>
                    To enroll your child at KIDDO VILLE, simply fill out the application form on our website or contact us directly. We will guide you through the registration process and answer any questions you may have.
                </p>
            </div>
        </div>
        ...
        <div class="faq">
            ...
            <div class="pannel">
                <p>
                    Yes! We provide nutritious meals and snacks that are tailored to the dietary needs of each child. We offer healthy options and can accommodate allergies and special diets as needed.
                </p>
            </div>
        </div>
        <!-- to redirect to ask questions -->
        <div class="faq">
            <button class="accordion">
                How can I contact KIDDO VILLE for further inquiries?
                <i class="fa-solid fa-chevron-down"></i>
            </button>
            <div class="pannel">
                <p>If you have any more questions or need further assistance, feel free to.</p>
                <button class="faq-contact" onclick="window.location.href='../Help/Help.html'">contact us here</button>
            </div>
        </div>
    </div>
