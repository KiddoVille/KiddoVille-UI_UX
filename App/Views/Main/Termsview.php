...
<body>
    ...
    <div class="navbar">
        ...
        <div class="navbar-links">
            ...
            <a href="<?=ROOT?>/Main/AboutUs"><button class="navbar-link" style="white-space: nowrap">About Us</button></a>
            <a href="<?=ROOT?>/Main/Help"><button class="navbar-link" style="white-space: nowrap">Contact Us</button></a>
        ...
        <div class="content">
            <div style="display: flex;">
                <div>
                    ...
                    <p>Welcome to [Daycare Name]. By using our services, you agree to comply with and be bound by these Terms of Service. Please read these terms carefully.</p>
                    
                    <h2>Acceptance of Terms</h2>
                    <p>By accessing and using our services, you acknowledge that you have read, understood, and agree to be bound by these terms and conditions. If you do not agree with any part of these terms, you must not use our services.</p>
                </div>
                <div class="illustration">
                    <img src="<?=IMAGE?>/Terms.png" alt="Terms Illustration" />
                </div>
            </div>
            
            <h2 style="margin-top: -10px;">Services Provided</h2>
            <p>[Daycare Name] provides childcare services for children aged [specify age range]. Our goal is to create a safe, nurturing environment for children to learn and grow.</p>
            
            <div style="display: flex; margin-top: -10px;">
                <div class="illustration">
                    <img src="<?=IMAGE?>/Terms2.png" alt="Terms Illustration" style="width: 600px; margin-right: 100px !important;" />
                </div>
                <div>
                    <h2>Enrollment and Fees</h2>
                    <p>To enroll your child, you must complete the registration form and pay the applicable fees. Fees are subject to change, and we will notify you of any changes in advance.</p>
                    
                    <h2>Payment Terms</h2>
                    <p>All fees must be paid on or before the due date specified in your enrollment agreement. Late payments may incur additional fees.</p>
                </div>
            </div>
            <h2 style="margin-top: -10px;">Parental Responsibilities</h2>
            <p>Parents are responsible for providing accurate and up-to-date information about their child, including medical history and emergency contacts. It is also the parent’s responsibility to notify us of any changes.</p>

            <div style="display: flex; margin-top: -10px; flex-direction: row;">
                <div>
                    <h2>Health and Safety</h2>
                    <p>Your child's health and safety are our top priorities. We adhere to strict health protocols, and we reserve the right to deny admission to any child who is ill or presents a health risk to others.</p>
                    
                    <h2>Termination of Services</h2>
                    <p>We reserve the right to terminate services if a child exhibits behavior that is harmful to themselves or others or if parents fail to comply with the terms of this agreement.</p>
                </div>
                <div class="illustration">
                    <img src="<?=IMAGE?>/Terms3.png" alt="Terms Illustration" style="width: 700px; margin-right: 100px !important;" />
                </div>
            </div>
            <h2  style="margin-top: 0px;">Limitation of Liability</h2>
            <p>[Daycare Name] shall not be liable for any indirect, incidental, or consequential damages arising out of your use of our services. Your use of our services is at your own risk.</p>
            ...
            <p style="margin-top: -10px; margin-bottom: -10px;">Email: <a href="mailto:KiddoVille@daycare.com" style="color: #007BFF; text-decoration: none;">KiddoVille@daycare.com</a></p>
            <p style="margin-bottom: -10px;">Phone: <a href="tel:+0714810928" style="color: #007BFF; text-decoration: none;">071 481 0928</a></p>
        </div>
    </div>
