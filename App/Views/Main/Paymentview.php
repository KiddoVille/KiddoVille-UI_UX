    ...
    <div class="popup-container">
        <div class="left-panel">
            ...
            <div class="contact-info">
                <img alt="Profile picture of Amanda" height="50" src="<?=IMAGE?>/face.jpeg" width="50" style="border: 4px solid darkblue;" />
                <p>
        ...
        <div class="right-panel">
            ...
            <img alt="Illustration of a person using a VR headset and working on a laptop" height="500"
                src="<?=IMAGE?>/help-payment.png" width="500" />
        </div>
    </div>
</body>
