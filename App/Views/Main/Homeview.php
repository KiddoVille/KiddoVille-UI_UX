...
<head>
    ...
    <link rel="stylesheet"
        ...
        data-tag="font" />
    <link rel="stylesheet" href="<?= CSS ?>/Main/Landing.css?v=<?= time() ?>" />
...
<body>
    ...
    <div class="backdrop" style="background:url(<?= IMAGE ?>/back-login.jpg); background-size:cover; ">
                ...
                <div class="view">
                    <div class="hero-section">
                        <div class="hero-content1">
                            ...
                            <button class="button-c first" onclick="window.location.href='<?= ROOT ?>/Main/Visit'">Visit US</button>
            ...
            <img alt="Kids" src="<?= IMAGE ?>/new-back.jpg" class="kids" />
                    ...
                    <div class="teacher-list">
                        ...
                        <div class="teachers block">
                            <div class="profile-1 ">
                                <div class="circle">
                                    <img alt="teacher" src="<?= IMAGE ?>/face.jpeg" />
                                </div>
                                <div class="name-box">
                                    <div class="name">
                                        <p>Sara Britney</p>
