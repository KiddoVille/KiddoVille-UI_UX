...
<head>
  <title>Edit Profile Page input</title>
...
<body>
  ...
  <div>
    <link href="<?=CSS?>/Manager/Profilepage.css" rel="stylesheet" />
    <div class="navbar">
      <div class="navbar-logo">
        <img src="<?= IMAGE ?>/Header logo.png" alt="Logo" style="height:80px ; width:100px" />
      </div>
      <div class="navbar-links">
        <a href="./Landing.html"><button class="navbar-link select">Home</button></a>
    ...
    <div class="landing-page-container">
      <div class="landing-page">
        ...
        <div class="content">
          ...
          <span class="p-1">
            <span class="fade-in">
              <textarea name="" id="" placeholder="Our daycare offers a stimulating and nurturing environment that
              ...
              skills and a love for learning."  required></textarea>
            </span>
          </span>
          <span class="Foster">
        ...
        <div class="Real">
          ...
          <span class="p-2">
            <span class="fade-in">
                <textarea placeholder="We understand how important it is for parents to stay informed
              ...
              relationship."  required></textarea>
        ...
        <div class="Efficient">
          ...
          <span class="p-3">
            <span class="fade-in">
                <textarea placeholder="Our daycare management system is designed to make the
              ...
              engaging activities for your children"  required></textarea>
            </span>
          </span>
          <span class="Stream">
    ...
    <div class="btn">
        <a href="Editprofilepage.html" class="backbtn" ><button>Back</button></a>
        <a href="Editprofilepage.html" class="editbtn" style="margin-left: 1330px;"><button>Save</button></a>
    </div>
  ...
  <div class="Footer" style="margin-top: 10px;">
    ...
    <div class="KiddoVille">Kiddo<br/>Ville</div>
        <div class="Group4">
            <div class="Home"><a href="../Landing/Landing.html">Home</a></div>
            <div class="AboutUs"><a href="../AboutUs/AboutUs.html">About Us</a></div>
            <div class="ContactUs"><a href="../Help/Help.html">Contact Us</a></div>
            <div class="Features"><a href="../Features/features.html">Features</a></div>
        </div>
        <div class="Group5">
            <div class="Contact"><a href="../FAQ/faq.html">FAQ</a></div>
            <div style="white-space: nowrap;" class="Address"><a href="../Report/Report.html">Report Problems</a></div>
            <div style="margin-top: 20px;" class="Address"><a href="../Terms of Service/Terms.html">Terms</a></div>
        </div>
        <div class="Group6">
            <div class="Contact"><a href="../Blog/Blog.html">Blog</a></div>
            <div class="Address"><a href="../Profile/Profilepage.html">Profile</a></div>
            <div style="margin-top: 20px; white-space: nowrap;" class="Address"><a href="../Report/Report.html">Privacy Policy</a></div>
        </div>
    <div class="Group7">
        <div class="Frame13">
