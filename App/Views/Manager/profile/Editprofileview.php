...
<head>
  ...
  <link rel="stylesheet"
    ...
    <link rel="stylesheet" href="<?=CSS?>/Manager/Profilepage.css">
</head>
...
<body>
  ...
  <div>
    ...
    <div class="btn">
        <a href="<?=ROOT?>/Manager/Home" class="backbtn" ><button>Back</button></a>
        <a href="<?=ROOT?>/Manager/Profile/editprofile" class="editbtn" style="margin-left: 1330px;"><button>Edit</button></a>
    </div>
  </div>
