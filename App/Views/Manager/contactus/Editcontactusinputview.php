...
<body>
  ...
  <form action="../Dashboard/Dashboard.html">
    <div class="contact-container">
      ...
      <div class="contact-box support-box">
        ...
        <div class="contact-details">
          ...
          <input type="text" value="011-1234567 " required><br>
          <a href="mailto:education@kiddoville.com"><input type="email" value="support@kiddoville.com" required></a><br>
      ...
      <div class="contact-box education-box">
        ...
        <div class="contact-details">
          ...
          <input type="text" value="011-1234567 " required><br>
          <a href="mailto:education@kiddoville.com"><input type="email" value="education@kiddoville.com" required></a><br>
          Monday–Friday, 8am–6pm
        </div>
      </div>
      ...
      <div class="contact-box press-box">
        ...
        <div class="contact-details">
          ...
          <a href="mailto:education@kiddoville.com"><input type="email" value="pr@kiddoville.com" required></a><br>
        </div>
      </div>
    </div>
    <div class="container">
      <div class="section">
        <div class="icon">
          ...
          <div>
            <h2>Research</h2>
            <input type="text" style="width: 800px;" required value="We're always working to expand the knowledge base at the intersection of technology and early childhood
              education to impact policy and practice."><br>
      ...
      <div class="section bordered">
        <div class="icon">
          ...
          <div>
            ...
            <input type="text" required value="Ready to make a difference? Explore career opportunities with us at KIDDO VILLE"
              style="width: 800px;">
        ...
        <div class="icon">
          ...
          <div>
            ...
            <input type="text" required
              value="Have other questions about KIDDO VILLE or want to share feedback? We'd love to hear from you!"
              style="width: 800px;">
      ...
      <div class="contact-info">
        <div class="info-box">
          <h3>Office location</h3><br />
          <i class="fas fa-home"></i><br />
          </i>
          <input type="text" required  placeholder="No:23/1, Bambalapitiya, Colombo 7." class="width:400px;height:43px;"><br />
        ...
        <div class="info-box">
          <h3>Mail address</h3><br />
          <i class="fas fa-envelope">
          </i><br />
          <input type="text" required placeholder="Example@gmail.com" class="width:400px;height:43px;"><br />
    ...
    <div>
      <a href="<?=ROOT?>/Manager/Home" style="color: white;"><button class="editbtn">Save</button></a>
    </div>
  </form>
  
  <div style="margin-top: -47px;">
    <a href="<?=ROOT?>/Manager/Contactus" style="color: white; margin-left:-1250px;"><button class="editbtn"
