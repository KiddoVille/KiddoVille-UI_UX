...
<head>
    ...
    <link rel="stylesheet" href="<?=CSS?>/ReChild/meal.css">
    ...
    <script src="<?=JS?>/ReChild/meal.js"></script>
...
<body style="background-image: url('<?=IMAGE?>/dashboard-background.jpeg');">
    ...
    <div class="container">
        <div class="sidebar minimized" id="sidebar1">
            ...
            <div class="help">
                <a href="#" style="text-decoration:none; color:purple"><i class="fas fa-question-circle"></i>
                    <span>Help</span></a>
            </div>
        </div>
        <!-- navigation -->
        <div class="sidebar-2" id="sidebar2" style="display: flex; flex-direction: row;">
            <div>
                ...
                <div class="family-section" style="margin-top: 10px;">
                    <ul>
                        <li class="hover-effect first" onclick="window.location.href = '<?=ROOT?>/ReParent/meal'">
        ...
        <div class="main-content">
            ...
            <div class="container-food">
                <img src="<?=IMAGE?>/meal.png"
                    style="margin-right: 500px; margin-left: -480px; margin-bottom: -120px; margin-top: -50px;">
                ...
                <img src="<?=IMAGE?>/snack.png"
                    style="margin-left: 800px; margin-right: -200px; margin-top: -80px; margin-bottom: -90px;">
                <!-- snack table -->
            ...
            <div class="task-container" id="tasknavbar"
                style="position: absolute; margin-top: -1246px; margin-right: 800px;">
        ...
        <div class="profile-card" id="profileCard">
            ...
            <button class="secondary-button"
                onclick="window.location.href ='<?=ROOT?>/ReChild/GuardianProfile'">Guardian profile</button>
