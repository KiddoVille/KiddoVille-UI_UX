...
<head>
    ...
    <link rel="stylesheet" href="<?=CSS?>/ReChild/Message.css" />
    <script src="<?=JS?>/ReChild/Upload-file.js"></script>
    <script src="<?=JS?>/ReChild/Messager.js"></script>
</head>
<style>
</style>
...
<body id="body-blur" class="">
    ...
    <!-- message header -->
    <div class="chat-window" style="margin-bottom: 30px; background: url('<?=IMAGE?>/Messenger.jpg')">
        <!-- Header -->
        <div class="header">
