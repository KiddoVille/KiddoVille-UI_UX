        ...
        <div class="main-content" style="height: 200vh;">
            ...
            <div class="report-page">
                ...
                <div class="report-header">
                    <div class="profile">
                        <div class="first-row">
                            ...
                            <h3 style="margin-top: -5px;">Abdulla Aurad </h3>
                        </div>
                        <div class="sub-details"
                            style="display: flex;flex-direction: column; justify-content: space-between;">
                            <p>Reg Number : <span>SRD110021</span></p>
                            <p style="margin-top: -10px;">Age: <span>6</span></p>
                            <p style="margin-top: -10px;">language: <span>English</span></p>
                        </div>
                    </div>
                    <div class="attendence-bar">
                        ...
                        <input style="margin-top: 0px; width: 300px" type="range" min="0" max="100" value="50" step="20" readonly>
                    </div>
                    <div class="timetable">
                ...
                <div class="subject-grades">
                    <div class="subject-grades-head" style="padding: 0px;">
                        <h3 style="margin-left: 20px;">Learning Checks</h3>
                    </div>
                ...
                <div class="social-behaviour">
                    <div class="social" style="width: 510px; margin-left: 0px;">
                        <div class="social-head">
                            <h3 style="display: inline;">Social Development</h3>
                        </div>
                        <div class="skills">
                            <span style="display: inline;">Connecting with Peers</span>
                            <input type="range" min="0" max="100" value="50" step="20" readonly style="margin-left: -80px !important;">
                        </div>
                        <div class="skills">
                            <span style="display: inline;">Connecting with Peers</span>
                            <input type="range" min="0" max="100" value="50" step="20" readonly style="margin-left: -80px !important;">
                    ...
                    <div class="behaviour" style="width: 500px;">
                        <div class="behaviour-head" style="margin-top: -15px;">
                            <h3>Behavioural Development</h3>
                        </div>
                        <div class="behaviour-skills" style="margin-top: -20px;">
                            <div class="text-line">
            ...
            <!-- tasks right navbar -->
            <div class="task-container" id="tasknavbar" style="position: fixed; margin-top: -1400px; margin-left: 1310px;">
