...
<head>
    ...
    <link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/5.15.3/css/all.min.css">
    <link rel="stylesheet" href="<?=CSS?>/ReChild/all-event.css">
    ...
    <script src="<?=JS?>/ReChild/all-event.js"></script>
</head>
...
<body style="overflow: hidden; background-image: url('<?=IMAGE?>/dashboard-background.jpeg');">
    <div class="container">
        ...
        <div class="sidebar-2" id="sidebar2" style="display: flex; flex-direction: row;">
            <div>
                ...
                <div class="family-section" style="margin-top: 10px;">
                    <ul>
                        <li class="hover-effect first" onclick="window.location.href = '../../Registered-Parent/Attendance/all-event.html'">
        ...
        <div class="main-content">
            ...
            <!-- messsage icon to redirect message page -->
            <div class="chatbox">
            ...
            <!-- To represent all the available packages -->
            <div class="fill">
                <img src="<?=IMAGE?>/back-arrow-2.svg" alt="back-arrow"
                    style="width: 24px; height: 24px; fill: #233E8D !important; margin-left: -1080px; cursor: pointer;"
                    class="back" onclick="window.location.href='<?=ROOT?>/ReChild/event'">
                ...
                <div class="packages" style="margin-top: -10px;">
                    ...
                    <div class="package-card">
                        <img alt="Classroom with colorful furniture and toys" src="<?=IMAGE?>/Assets/packages.png" />
                        <p> Event Name: Drawing</p>
                        <p> Date: 10/09/2024</p>
                        <p> Time: 10:00 - 11:00</p>
                        <button class="eventbtn">
