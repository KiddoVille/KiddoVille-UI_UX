...
<head>
    ...
    <link rel="stylesheet" href="<?=CSS?>/ReChild/Attendance.css">
...
<body style="background-image: url('<?=IMAGE?>/dashboard-background.jpeg');">
    ...
    <div class="container">
        ...
        <!-- the sidebar to select child or parent -->
        <div class="sidebar-2" id="sidebar2" style="display: flex; flex-direction: row;">
            <div>
                <h2 style="margin-top: 25px;">Familty Ties</h2>
                <div class="family-section" style="margin-top: 10px;">
                    <ul>
                        <li class="hover-effect first" onclick="window.location.href = '<?=ROOT?>/ReParent/Attendance'">
        ...
        <div class="main-content">
            ...
            <div class="header">
                ...
                <!-- the bell icon and it's drop down -->
            ...
            <div class="stats">
                <div class="stat">
                    ...
                    <span style="color: #00FFFF;font-weight: 50;">attended daycare</span>
                </div>
                <div class="stat">
                    ...
                    <span style="color: #00FFFF;font-weight: 50;">10/12 arrived at 9:30 am</span>
                </div>
                <div class="stat">
                    ...
                    <span style="color: #00FFFF;font-weight: 50;">kiddo is having breakfast now</span>
                </div>
            </div>
            ...
            <div class="saperate">
                ...
                <!-- container to represent holidays -->
                <div class="holidays">
            ...
            <!-- message icon and it's redirection btn -->
            <a href="<?=ROOT?>/ReChild/Message" class="chatbox">
                <img 
                    src="<?=IMAGE?>/message.svg" 
                    class="fas fa-comment-dots"
                    style="margin-left: 12px; width: 24px; height: 24px; margin-top: 2px;" 
                    alt="Message Icon" 
                />
        ...
        <div class="profile-card" id="profileCard">
            ...
            <button class="profile-button" onclick="window.location.href ='<?=IMAGE?>/ChildProfile'">
                Profile
            </button>
            <button class="secondary-button" onclick="window.location.href ='<?=IMAGE?>/ParentProfile'" >
                Parent profile
            </button>
            <button class="secondary-button" onclick="window.location.href ='<?=IMAGE?>/GuardianProfile'">
                Guardian profile
            </button>
        ...
        <!-- represnt tasks in a right navbar -->
