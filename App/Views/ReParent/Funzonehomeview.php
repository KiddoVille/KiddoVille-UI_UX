...
<head>
    ...
    <link rel="stylesheet" href="<?=CSS?>/ReParent/funzonehome.css">
        ...
        <ul>
            <li class="hover-effect unselected">
                <a href="<?=ROOT?>/ReParent/Home">
                    <i class="fas fa-home" style="font-size: 20px; color: black; margin-left: -2px;"></i>
                    <span>Home</span>
                </a>
            </li>
            <li class="hover-effect unselected">
    ...
    <div class="main-content" id="main-content" style="background: url('<?=IMAGE?>/funzone-backgound.png');">
        ...
        <div class="contents" id="contents">
            <div class="grid" id="grid">
                <div class="item" onclick="window.location.href='<?=ROOT?>/ReParent/video'">
                    <img alt="Over It" height="150" src="<?=IMAGE?>/funzone-1.png" width="150" />
                    <h3>Over It</h3>
                    <p> Small description</p>
                </div>
                <div class="item" onclick="window.location.href='<?=ROOT?>/ReParent/youtube'">
