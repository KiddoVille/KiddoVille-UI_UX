...
<head>
    ...
    <link rel="stylesheet" href="<?=CSS?>/ReParent/package.css">
    ...
    <script src="<?=JS?>/ReParent/Price.js"></script>
    <script src="<?=JS?>/ReParent/package.js"></script>
</head>
        ...
        <div class="sidebar-2" id="sidebar2" style="display: flex; flex-direction: row;">
            <div>
                ...
                <div>
                    ...
                    <ul>
                        <li class="hover-effect first" onclick="window.location.href = '<?=ROOT?>/ReParent/package'">
        ...
        <div class="main-content" id="main-content">
            ...
            <div class="modal" id="PackageModal">
                <div class="View-Package">
                    ...
                    <img src="../../../Assets/package-back.jpg" alt="packages" class="package-img">
                </div>
            </div>
            <div class="chatbox">
            ...
            <div class="fill" style="background-color: white; box-shadow: 4px 4px 15px rgba(0, 0, 0, 0.3);">
