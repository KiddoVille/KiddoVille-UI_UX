            ...
            <form id="editprofileright">
                <div class="rightcon">
                    ...
                    <div class="Save-con" style="margin-top: 20px;">
                        <button type="button" class="Save" onclick="window.location.href='<?=ROOT?>/ReParent/GuardianProfile'">
                            Cancel
                        </button>
                        <button type="button" class="Save" onclick="window.location.href='<?=ROOT?>/ReParent/GuardianProfile'">
                            Save
