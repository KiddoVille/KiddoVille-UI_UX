...
<head>
    ...
    <link rel="stylesheet" href="<?=CSS?>/ReParent/Message.css" />
    <script src="<?=JS?>/ReParent/Upload-file.js"></script>
    <script src="<?=JS?>/ReParent/Message.js"></script>
</head>

<body id="body-blur" style="background-image: url('<?=IMAGE?>/dashboard-background.jpeg');">
    <!-- refresh animation -->
