...
<head>
    ...
    <link rel="stylesheet" href="<?=CSS?>/ReParent/reservation.css">
    ...
    <script src="<?=JS?>/ReParent/reservation.js"></script>
</head>
        ...
        <div class="sidebar-2" id="sidebar2" style="display: flex; flex-direction: row;">
            <div>
                ...
                <div>
                    ...
                    <ul>
                        <li class="hover-effect first" onclick="window.location.href = '<?=ROOT?>/ReParent/reservation'">
        ...
        <div class="main-content" id="main-content">
            ...
            <div class="stats">
                <div class="stat">
                    ...
                    <p style="margin-bottom: 3px; color: #D3D3D3;">03/04 reservations</p>
                ...
                <div class="stat">
                    ...
                    <p style="margin-bottom: 3px;color: #D3D3D3;">1 reservation</p>
                ...
                <div class="stat">
                    ...
                    <p style="margin-bottom: 3px;color: #D3D3D3;">2 reservations</p>
                    ...
                    <table id="history" style="display: none ;">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="edit">
                                    <i class="fas fa-eye reservation"></i>
                                    <i class="fas fa-star feedbackbtn"></i>
                                </td>
                            </tr>
                            <tr>
                                <td>11000011</td>
