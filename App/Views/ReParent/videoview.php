...
<head>
    ...
    <link rel="stylesheet" href="<?=CSS?>/ReParent/video.css">
    <link rel="stylesheet" href="<?=CSS?>/ReParent/videomain.css">
    ...
    <script src="<?=JS?>/ReParent/Comment.js"></script>
    <script src="<?=JS?>/ReParent/Progress.js"></script>
</head>
...
<body>
    ...
    <div class="sidebar" style="background: url('<?=IMAGE?>/funzone-side.png') no-repeat center center">
        ...
        <div class="bottom-text">
            <a href="<?=ROOT?>/ReParent/Home" class="nav-link" style="cursor: pointer !important;">
            ...
            <div class="video-container">
                <div class="video-content">
                    <div class="video-player">
                        <video id="video" width="100%" height="100%" src="<?=IMAGE?>/video.mp4" type="video/mp4"></video>
                    </div>
                    <div class="video-controls">
                        ...
                        <div class="right-controls">
                            ...
                            <a href="<?=ROOT?>/ReParent/fullvideo" id="fullscreen" style="display: block;">
