...
<head>
    ...
    <link rel="stylesheet" href="<?=CSS?>/ReParent/meal.css">
    ...
    <script src="<?=JS?>/ReParent/meal.js"></script>
...
<body style="background-image: url('<?=IMAGE?>/dashboard-background.jpeg');">
    <div class="container">
        ...
        <div class="sidebar-2" id="sidebar2" style="display: flex; flex-direction: row;">
            <div>
                ...
                <div>
                    ...
                    <ul>
                        <li class="hover-effect first" onclick="window.location.href = '<?=ROOT?>/ReChild/meal'">
        ...
        <div class="profile-card" id="profileCard">
            ...
            <button class="profile-button" onclick="window.location.href ='<?=ROOT?>/ReParent/ParentProfile'">Profile</button>
            <button class="secondary-button" onclick="window.location.href ='<?=ROOT?>/ReParent/GuardianProfile'">Guardian profile</button>
