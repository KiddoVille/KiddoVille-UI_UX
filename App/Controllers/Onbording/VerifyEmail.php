...
class VerifyEmail
{
    ...
    public function index($data = null){
        ...
        $body = '
            ...
            <body>
                <div class="email-container">
                    ...
                    <div class="content">
                        <p class="greeting">Welcome to KiddoVille!</p>

                        <div class="message">
                            <p>Thank you for signing in. To continue, please verify your email address.</p>
                            <p>Enter the verification code below to complete your login and access your account:</p>
                        </div>
                        ...
                        <div class="instructions">
                            ...
                            <ul>
                                <li>Enter this code on the email verification screen</li>
                                <li>Once verified, you’ll be successfully logged in to KiddoVille</li>
                                <li>Keep this code private — don’t share it with anyone</li>
                            </ul>
                        </div>

                        <div class="security-notice">
                            <p><strong>Didn\'t try to log in?</strong> If this wasn\'t you, you can safely ignore this email. If you\'re concerned, contact <a href="mailto:support@kiddoville.com">support@kiddoville.com</a>.</p>
                        </div>
        ...
        $this->view('Onbording/VerifyEmail', $data);
    }
    ...
    public function verify(){
        ...
        if ($enteredOtp == $storedOtp) {
            ...
            $session->unset('OTP');
            $session->set("EMAIL_VARIFIED", true);

            // if($User->Role == "User"){
            //     redirect('Onbording/ParentUser');
            // }
            // else if($User->Role == "Maid"){
            //     redirect('Onbording/Maid');
            // }
            // else if($User->Role == "Teacher"){
            //     redirect('Onbording/Teacher');
            // }
            // else if($User->Role == "Manager"){
            //     redirect('Onbording/Manager');
            // }
            // else if($User->Role == "Receptionist"){
            //     redirect('Onbording/Receptionist');
            // }
            // else if($User->Role == "Doctor"){
            //     redirect('Onbording/Doctor');
            // }
